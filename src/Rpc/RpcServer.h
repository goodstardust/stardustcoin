...
private:
  ...
  bool on_get_txs_by_height(const COMMAND_RPC_TXS_BY_HEIGHT::request& req, COMMAND_RPC_TXS_BY_HEIGHT::response& res);
  bool on_get_txs_pool(const COMMAND_RPC_TXS_POOL::request& req, COMMAND_RPC_TXS_POOL::response& res);
